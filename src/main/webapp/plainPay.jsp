...
<html>
    ...
    <body>
        ...
        <table border="0" cellspacing="0" cellpadding="0" class="table_ui">
            ...
            <input type="hidden" name="card_no" value="<%=request.getParameter("card_no") %>"/>
            <input type="hidden" name="acct_name" value="<%=new String(request.getParameter("acct_name").getBytes("ISO-8859-1"),"UTF-8") %>"/>
            <input type="hidden" name="id_no" value="<%=request.getParameter("id_no") %>"/>
            <input type="hidden" name="bind_mob" value="<%=request.getParameter("bind_mob") %>"/>
            <input type="hidden" name="bank_code" value="<%=request.getParameter("bank_code") %>"/>
            <input type="hidden" name="card_type" value="<%=request.getParameter("card_type") %>"/>
            <input type="hidden" name="flag_pay_product" value="<%=request.getParameter("flag_pay_product") %>"/>
             <input type="hidden" name="paymod" value="plain"/>
             <input type="hidden" name="money_order" value="1"/>
