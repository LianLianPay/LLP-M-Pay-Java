...
<html>
    ...
    <body>
        ...
        <span class="logo"><a href="javascript:void(0)">连连统一网关支付DEMO</a>
        </span>
          ...
          <form action="" method="post" name="form1">
           ...
           <tr>
                <td  align="left">
                 ...
                 <td  align="center">
                    <input type="text" id="card_no" name="card_no" class="i_text"/>
                </td>
            </tr>
           <tr>
                <td  align="left">
                 ...
                 <td  align="center">
                    <input type="text" id="acct_name" name="acct_name" class="i_text"/>
                </td>
            </tr>
           <tr>
                <td  align="left">
                 ...
                 <td  align="center">
                    <input type="text" id="id_no" name="id_no" class="i_text"/>
                </td>
            </tr>
            <tr>
                <td  align="left">
                 ...
                 <td  align="center">
                    <input type="text" id="bank_code" name="bank_code" class="i_text"/>
                </td>
            </tr>
            <tr>
                <td  align="left">
                 ...
                 <td  align="center">
                    <input type="text" id="card_type" name="card_type" class="i_text"/>
                </td>
            </tr>
            <tr>
                <td  align="left">
                 ...
                 <td  align="center">
                    <input type="text" id="flag_pay_product" name="flag_pay_product" placeholder="0 快捷、1 认证、2 网银、5 新认证支付" class="i_text"/>
                </td>
            </tr>
            <tr>
